    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                        ...
                        <div className="flex items-center space-x-4 mb-6">
                            {game.rating && (
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-gray-600">Note critique</span>
                                </div>
                            )}
                            {game.total_rating && (
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-gray-600">Note générale</span>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            <h3 className="font-semibold text-gray-900 mb-2">Date de sortie</h3>
                            <p className="text-gray-600">{formatDate(game.first_release_date)}</p>
                        </div>

                        {game.platforms && game.platforms.length > 0 && (
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-2">Plateformes</h3>
                        ...
                        {developers && developers.length > 0 && (
                            <div>
                                <h3 className="font-semibold text-gray-900 mb-2">Développeurs</h3>
                                <div className="flex flex-wrap gap-2">
                                    {developers.map((dev) => (
                                        <span
                                            key={dev.id}
                    ...
                    {game.screenshots && game.screenshots.length > 0 && (
                        <div className="mb-8">
                            <h3 className="text-2xl font-semibold text-gray-900 mb-4">Screenshots</h3>
            ...
            {similarGames && similarGames.length > 0 && (
                <div className="mt-16">
                    <h2 className="text-3xl font-bold text-gray-900 mb-8">Jeux similaires</h2>
